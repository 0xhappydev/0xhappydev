...
I am a **Software Engineer and Blockchain Innovator** focused on building robust, scalable, and user-centric applications. I have hands-on experience with **LangChain, LLMs, NLP, Solidity, Rust, Go, Haskell, Anchor, React, and Node.js**.

My core expertise includes developing **AI agents, smart contracts, decentralized applications (dApps), NFT marketplaces, web wallets, NFT games, blockchain nodes, trading bots**, and **high-performance, dynamic front-end interfaces**. I am particularly interested in combining **AI and blockchain** to create practical, production-ready systems.

From designing secure smart contracts and token economics to delivering responsive, intuitive UI/UX, I approach every project with precision, ownership, and a strong engineering mindset. I enjoy solving complex problems and turning ideas into reliable, scalable products.
